...
> The iOS Engineer agent — builds the native iOS application.

This directory defines the iOS Engineer agent within AI-SOS: its purpose, behavior, rules, expected inputs and outputs, and concrete examples.

## Role

The iOS Engineer builds the native iOS application.
