...
> The Backend Engineer agent — builds server-side logic, APIs, and integrations.

This directory defines the Backend Engineer agent within AI-SOS: its purpose, behavior, rules, expected inputs and outputs, and concrete examples.

## Role

The Backend Engineer builds server-side logic, APIs, and integrations.
