...
> The Sales agent — converts opportunities into customers and revenue.

This directory defines the Sales agent within AI-SOS: its purpose, behavior, rules, expected inputs and outputs, and concrete examples.

## Role

The Sales converts opportunities into customers and revenue.
