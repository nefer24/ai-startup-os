...
**Date :** 2026-09-06 (ARP v3, après première évaluation holdout)
**Commits :** départ `b8c2771` (develop, PR #142 fusionnée) → freeze v1 `b1fe105` → freeze v2 `9e62b9b` → **freeze v3 `18075c2`** (correction du blocage `json_invalid`)
