...
| [`11-strategic-council.md`](./11-strategic-council.md) | Le Conseil Stratégique Dynamique : instance IA consultative, activable, rattachée au CEO |
...
4. [`02-orchestrator.md`](./02-orchestrator.md), [`11-strategic-council.md`](./11-strategic-council.md), [`03-expert-councils.md`](./03-expert-councils.md) — la coordination, la réflexion stratégique et la délibération.
...
- **Terminologie :** les termes canoniques (Orchestrateur, Conseils d'Experts, Départements, Agents spécialisés, Conseil Stratégique Dynamique, spécialité…) sont définis dans le [`00-glossary.md`](./00-glossary.md) et employés de façon uniforme.
